...
setwd("/Users/lilivandermeersch/Library/Mobile Documents/com~apple~CloudDocs/❤️ MSc Statistics and Data Science ❤️/☀️🌸 Year 3./II./SEM/Assignment/ESS7")
...
################################################################################
# Importing the data
ess_df <- import("/Users/lilivandermeersch/Library/Mobile Documents/com~apple~CloudDocs/❤️ MSc Statistics and Data Science ❤️/☀️🌸 Year 3./II./SEM/Assignment/ESS7/ESS7_HU.R")
# Data Exploration ------------------------------------------------------------------
View(ess_df) 
...
fitMeasures(fit_mimic_a, c("logl","AIC", "BIC", "chisq", "df", "pvalue", "cfi", "tli","rmsea"), output = "matrix")
...
pdf("fit_mimi6.pdf")
# Visualization
semPaths(fit_mimic6, what = "std", optimizeLatRes = TRUE, layout = "tree", style = "ram", nCharNodes = 0, intercepts = FALSE, fade = FALSE, edge.color = "black", rotation = 2)
dev.off()
...
# Visualization
semPaths(fit_mediation_fiml2, what = "std", optimizeLatRes = TRUE, layout = "tree", nCharNodes = 0, intercepts = FALSE, fade = FALSE)
dev.off()
...
# boot_metric <- bootstrapLavaan(fit_metric, R = 1000)
...
# Man and women answer different at level zero latent factor. 
# Gender influences how they respond.
...
lavTestScore(fit_scalar_psppsgv_ptcpplt_psppipl) # => reached partial invariance
